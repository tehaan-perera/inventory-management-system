...
const Radio = class {
  ...
  connectedCallback() {
    this.legacyFormController = (0,_form_controller_64edeaad_js__WEBPACK_IMPORTED_MODULE_2__.c)(this.el);
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new radio syntax.`, this.el);
    ...
    }, this.renderRadioControl(), (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
