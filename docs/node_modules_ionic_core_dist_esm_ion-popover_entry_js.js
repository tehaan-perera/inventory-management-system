...
/* harmony import */ var _index_6a0ccabb_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-6a0ccabb.js */ 4748);
/* harmony import */ var _animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./animation-8aa13916.js */ 5419);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,C_Projects_stockApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const backdropAnimation = (0,_animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const contentAnimation = (0,_animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__.c)();
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const backdropAnimation = (0,_animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const wrapperAnimation = (0,_animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const contentAnimation = (0,_animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const viewportAnimation = (0,_animation_8aa13916_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  backdropAnimation.addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidDismiss", 7);
  ...
  connectedCallback() {
    ...
    (0,_overlays_6c9feb7e_js__WEBPACK_IMPORTED_MODULE_6__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (0,_overlays_6c9feb7e_js__WEBPACK_IMPORTED_MODULE_6__.k)(el);
    this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);
    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_40e42e7f_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  componentDidLoad() {
    const {
  ...
  present(event) {
    ...
    return (0,C_Projects_stockApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if ((0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__.m)(el)) {
        yield (0,_index_6a0ccabb_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_6a0ccabb_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }
      yield (0,_overlays_6c9feb7e_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_6c9feb7e_js__WEBPACK_IMPORTED_MODULE_6__.o)(_this2.el, _this2.el);
      }
      unlock();
    })();
  }
  ...
  dismiss(data, role, dismissParentPopover = true) {
    ...
    return (0,C_Projects_stockApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const shouldDismiss = yield (0,_overlays_6c9feb7e_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_6c9feb7e_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_6c9feb7e_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    const desktop = (0,_ionic_global_40e42e7f_js__WEBPACK_IMPORTED_MODULE_7__.a)('desktop');
    ...
    }), !parentPopover && (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
    ...
    }, enableArrow && (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "popover-arrow",
      part: "arrow"
    }), (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
