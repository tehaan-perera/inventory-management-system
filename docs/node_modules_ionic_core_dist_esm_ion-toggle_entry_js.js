...
/* harmony import */ var _ionic_global_40e42e7f_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ionic-global-40e42e7f.js */ 9451);
...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_40e42e7f_js__WEBPACK_IMPORTED_MODULE_9__.c.get('toggleOnOffLabels');
  ...
  connectedCallback() {
    ...
    return (0,C_Projects_stockApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.legacyFormController = (0,_form_controller_64edeaad_js__WEBPACK_IMPORTED_MODULE_2__.c)(_this2.el);
      /**
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_912e3e13_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.toggleChecked();
      (0,_haptic_1243b917_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
  ...
  renderToggleControl() {
    const mode = (0,_ionic_global_40e42e7f_js__WEBPACK_IMPORTED_MODULE_9__.b)(this);
    const {
      enableOnOffLabels,
      checked
    } = this;
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderToggle() {
    ...
    }, this.inheritedAttributes)), (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': !this.hasLabel
      }
    }, (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", null)), (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new toggle syntax.`, this.el);
    ...
    }, this.renderToggleControl(), (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
    }, labelText), (0,_index_7c9b1bca_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
      type: "checkbox",
      role: "switch",
      "aria-checked": `${checked}`,
      disabled: disabled,
